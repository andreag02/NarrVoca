    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="email" className="dark:text-slate-200">
          {loginTranslations[language].emailLabel}
        </Label>
        <Input
          id="email"
          name="email"
          type="email"
          placeholder={loginTranslations[language].emailPlaceholder}
          required
      ...
      <div className="space-y-2">
        <Label htmlFor="password" className="dark:text-slate-200">
          {loginTranslations[language].passwordLabel}
        </Label>
        <Input
          id="password"
          name="password"
    ...
    try {
      ...
      setError(
        error instanceof Error
          ? error.message
          : loginTranslations[language].unexpectedError,
      );
    } finally {
      setIsLoading(false);
    }
